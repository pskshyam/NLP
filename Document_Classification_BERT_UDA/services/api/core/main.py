...
from services.api.core.bert import modeling
from services.api.utils import proc_data_utils
from services.api.utils import raw_data_utils
...
flags.DEFINE_string('bind', '', help=('Server address'))
flags.DEFINE_integer('timeout', 30, help=('Server timeout'))
...
flags.DEFINE_string(
    ...
    help="The input data dir of the prediction data. Should contain "
    "`tf_examples.tfrecord*`")
flags.DEFINE_string(
    "unsup_data_dir", None,
...
flags.DEFINE_integer(
    ...
    help="Base batch size for prediction.")
flags.DEFINE_integer(
...
flags.DEFINE_string('graceful-timeout', '', 'kernel')
flags.DEFINE_string('b', '', 'kernel')
